...
class TestOperations(unittest.TestCase):
    ...
    def test_find_first_5_minimums(self):
        ...
        self.assertEqual(find_first_5_minimums([10, 5, 3, 8, 2, 7, 1]), [1, 2, 3, 5, 7])  # стандартний випадок
        self.assertEqual(find_first_5_minimums([4, 2]), [2, 4])  # якщо елементів менше 5
        self.assertEqual(find_first_5_minimums([]), [])  # якщо список порожній

    def test_find_first_5_maximums(self):
        """знаходження 5 найбільших елементів"""
        self.assertEqual(find_first_5_maximums([10, 5, 3, 8, 2, 7, 1]), [10, 8, 7, 5, 3])  # стандартний випадок
        self.assertEqual(find_first_5_maximums([4, 2]), [4, 2])  # якщо менше 5 елементів
        self.assertEqual(find_first_5_maximums([]), [])  # якщо порожній список
